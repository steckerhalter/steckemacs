...
(global-set-key (kbd "C-h N") 'diff-hl-revert-hunk)
...
(global-set-key (kbd "C-h C-f") 'elisp-slime-nav-find-elisp-thing-at-point)
(global-set-key (kbd "C-h g") 'grep-find)
(global-set-key (kbd "C-S-h C-S-g") 'find-grep-dired)
(global-set-key (kbd "C-h C-o") 'occur)
(global-set-key (kbd "C-h C-g") 'ag-project)
(global-set-key (kbd "C-h C-l") 'helm-locate)
(global-set-key (kbd "C-h C-y") 'projectile-find-file)
...
(global-set-key (kbd "C-h r") 'google-translate-query-translate)
(global-set-key (kbd "C-h C-r") 'google-translate-query-translate-reverse)
(global-set-key (kbd "C-h n") 'howdoi-query)
(global-set-key (kbd "C-h C-c") 'helm-google-suggest)
